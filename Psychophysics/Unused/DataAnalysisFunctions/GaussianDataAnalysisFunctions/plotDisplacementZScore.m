function Q = plotDisplacementZScore(Q)
    ...
    for ii = 1:length(Q.correlationVals)
        ...
        scatter(Q.correlationVals(ii),ix,50,[0.8500 0.3250 0.0980]); % red
        hold on
        ...
        scatter(Q.correlationVals(ii),ix,50,[0 0.4470 0.7410]); % blue
        hold on

    end

    hold off
    title('Gaussian Field Eye Displacement Z Score > 1');
    yline(0,'--');
