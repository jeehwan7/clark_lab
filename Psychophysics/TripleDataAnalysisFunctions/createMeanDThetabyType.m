function [meanDThetabyCoherence, meanDThetabyTriple, tripleType] = createMeanDThetabyType(start, finish, numTrials, dThetabyTrialWithoutSaccades, coherences, directions, responses, types, parities)
