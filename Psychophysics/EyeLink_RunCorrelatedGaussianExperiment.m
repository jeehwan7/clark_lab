...
% Save Results File
if ~isfolder('./correlatedGaussianresults'); mkdir('./correlatedGaussianresults'); end
startTime = datestr(now,'yyyy.mm.dd_HHMM');
mkdir(['./correlatedGaussianresults/','Subject',num2str(subjectID),'_',startTime]);
save(['./correlatedGaussianresults/','Subject',num2str(subjectID),'_',startTime,'/','Subject',num2str(subjectID),'_',startTime,'.mat'],'subjectID','startTime','param','pxPermm','screenWidthpx');

% Create EyeLink Data Folder (edf files)
if ~isfolder(['./correlatedGaussianresults/','Subject',num2str(subjectID),'_',startTime,'/EdfFiles'])
    mkdir(['./correlatedGaussianresults/','Subject',num2str(subjectID),'_',startTime,'/EdfFiles']);
end
...
save(['./correlatedGaussianresults/','Subject',num2str(subjectID),'_',startTime,'/','Subject',num2str(subjectID),'_',startTime,'.mat'],'stimuli','directions','results','-append');
